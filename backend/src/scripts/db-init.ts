    ...
    try {
        ...
        if (parseInt(drawCount.rows[0].count) === 0) {
            ...
            await client.query(`
                ...
                VALUES ('The Founding Arena Draw', '$50 CDN Google Gift Card', 'The first official reward for the Events Arena community. Winner will be announced on June 1st.', 'soccer', 'active', '2026-06-01 00:00:00')
            `);
        }
