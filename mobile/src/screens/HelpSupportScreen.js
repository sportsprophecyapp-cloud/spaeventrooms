...
const HelpSupportScreen = () => {
    ...
    const faqs = [
        ...
        },
        {
            ...
            answer: "You can earn rewards from our sponsors! Check the Weekly Draw screen for current reward details. Remember, this requires no purchases - all rewards are sponsor-provided, not cash."
        },
        {
            id: 8,
        ...
        },
        {
            ...
            answer: "A mobile app is in development! Our Android version has been submitted to the Google Play Store and is awaiting approval. It is not yet available to download. iOS is coming in the future."
        },
        {
            id: 11,
        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.appInfo}>
                    <Text style={styles.appName}>Events Arena</Text>
