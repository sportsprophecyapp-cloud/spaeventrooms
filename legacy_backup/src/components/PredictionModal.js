...
const PredictionModal = ({ visible, onClose, event, initialTeam, onPredictionSuccess, onLoadNextGame }) => {
    ...
    useEffect(() => {
        if (visible) {
            // Always reset first to avoid stale state
    ...
    const handleSubmit = async () => {
        ...
        if (!selectedWinner) {
            ...
            Alert.alert('Selection Required', 'Please tap on a team logo to select who you think will win.');
            return;
        }
                ...
                <View style={styles.modalContainer}>
                    ...
                    <Animated.View style={[styles.contentWrapper, { transform: [{ translateX: slideAnim }] }]}>
                        <ScrollView showsVerticalScrollIndicator={false} style={styles.content}>
                            ...
                            {/* Selected Team Indicator - Explicit Feedback */}
                            {selectedWinner && (
                                <View style={styles.selectionIndicator}>
                                    <Text style={styles.selectionLabel}>PREDICTING TO WIN:</Text>
                                    <View style={styles.selectedTeamBadge}>
                                        <Text style={styles.selectedTeamText}>{selectedWinner}</Text>
