...
import { getBadgeForUser } from '../helpers/badgeHelper';
        ...
        <div className={`${styles.container} glass`}>
            ...
            <div className={styles.feed} ref={scrollRef}>
                {loading ? <div className={styles.loading}>Accessing Arena Channel...</div> : 
                 messages.map((msg) => {
                    const tieredBadge = getBadgeForUser(msg.user_id);
                    return (
                        <div key={msg.id} className={styles.message}>
                            <div className={styles.meta}>
                                ...
                                {tieredBadge && !msg.permissions?.includes('super_admin') && !msg.permissions?.includes('day_one') && (
